...
/** Complete the code relative to Task3 here.
 * Feel free to add more classes/interfaces if necessary.
 * 
 * Replace this comment with your own.
 *
 * Include a description of your approach to resource contention and to liveness 
 * issues in threads. Provide a couple of (short) sentences to discuss:
 * - what are the potential issues due to concurrent access to the shelves, the order queues and the delivery chain;
 * - how you made sure that your solution is not causing deadlock/livelock;
 * - whether starvation may occur, and where; and what is your approach to deal with it.
 * 
 * @author 18016286
 */
public class PizzeriaItalia implements Pizzeria {
